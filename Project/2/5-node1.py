...
def Receive(P):
    ...
    for i in range(0, int(fs / chunk * record_time)):
        ...
        t+=chunk/4
        # if t>15000 and t<39000 and Check_e(data):
        #     print("link error!")
        ...
        for s in range(64):
            ...
            if s==63:
                ...
                if mac_time>4:
                    ...
                    print("NODE1 RTT: "+str(mac_time)+" s")
...
def Send(P):
    ...
    for i in range(n_frame):
        ...
        for s in t_str:
            if s=='1':
                stream.write(signal_1_eee.tobytes())
            elif s=='0':
                stream.write(signal_0_eee.tobytes())
            else:
                print("error!")
                exit(1)
        #play the data
...
length_sig=len(signal_0_iii)
p_num=length_frame_iii
record_time=seconds_iii*(n_frame*8*(length_head/length_sig+length_frame_iii)+ADD)+more_time
